        ...
        try {
            switch (this.name)
            {
                ...
                case "boolean":
                    ...
                    break;
                case "itemstack":
                    ps.setString(index, TitanSQL.encode((ItemStack)value));
                    break;
                case "location":
                    ps.setString(index, TitanSQL.encode((Location)value));
                    break;
                case "uuid":
                    ps.setString(index, ((java.util.UUID)value).toString());
                    break;
                case "intlist":
                    ps.setString(index, TitanSQL.encode((List<Integer>)value));
                    break;
                case "stringlist":
                    ps.setString(index, TitanSQL.encode((List<String>)value));
                    break;
                case "itemlist":
